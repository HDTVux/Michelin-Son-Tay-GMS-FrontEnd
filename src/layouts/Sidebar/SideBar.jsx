...
const NAV_GROUPS = [
        ...
        subGroups: [
            {
                ...
                icon: <User size={15} />,
                items: [
                    { id: 'customer-manager', label: 'Danh bạ khách hàng', path: '/customer-manager', icon: <User size={18} />, roles: [STAFF_ROLE.RECEPTIONIST, STAFF_ROLE.ADMIN] },
            ...
            },
            {
                ...
                items: [
                    ...
                    { id: 'attendance-request-management', label: 'Duyệt đơn chấm công', path: '/attendance-request-management', icon: <ClipboardList size={18} />, roles: [STAFF_ROLE.MANAGER, STAFF_ROLE.ADMIN] },
                    { id: 'attendance-requests-nav', label: 'Chấm công bù / Xin nghỉ', path: '/attendance-requests', icon: <FileClock size={18} />, roles: 'ALL' },
                    { id: 'staff-attendance-nav', label: 'Lịch sử chấm công', path: '/staff-attendance', icon: <Clock size={18} />, roles: 'ALL' },
                ]
            },
            {
                id: 'sub-marketing',
    ...
    },
    {
        ...
        items: [
            ...
            { id: 'staff-attendance-personal', label: 'Lịch sử chấm công', path: '/staff-attendance', icon: <Clock size={18} />, roles: 'ALL' },
