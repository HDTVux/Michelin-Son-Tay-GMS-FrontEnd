...
const NAV_GROUPS = [
	...
	},
	{
		...
		items: [
			...
			{ id: 'shift-management', label: 'Ca & Điểm danh', path: '/shift-management', icon: <IconCalendar />, roles: [STAFF_ROLE.MANAGER, STAFF_ROLE.ADMIN], },
			{ id: 'service-management', label: 'Quản lý dịch vụ', path: '/service-management', icon: <IconSettings />, roles: [STAFF_ROLE.MANAGER], },
			{ id: 'promotion-management', label: 'Quản lý khuyến mãi', path: '/promotion-management', icon: <IconPromotion />, roles: [STAFF_ROLE.MANAGER, STAFF_ROLE.ADMIN], },
